...
Uudella roolilla on ylläpitäjän oikeudet (SUPERUSER) ja se on voimassa 31. joulukuuta 2050 asti.
...
:::hint-box
Jos uloskirjautuminen ei auta, niin voit sulkea kaikki sessiot, paitsi se joka sinulla on auki, seuraavalla komennolla:
...
Huomaat, että **pg_tablespace_location**-kenttä on tyhjä. Tämä tarkoittaa, että kyseiset taulutilat sijaitsevat kotihakemistossa. 
