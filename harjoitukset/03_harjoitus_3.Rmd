...
<button onclick="toggleAnswer(this)" class="btn answer_btn">lisävinkki</button>

:::hidden-box
:::code-box
```sql
SELECT
kunta_suomeksi, kunta_ruotsiksi, funktio_tekstin_pituus(kunta_suomeksi) AS "Pituus"
FROM
skeema.taulu
WHERE
kunta_suomeksi <> kunta_ruotsiksi AND funktio_tekstin_pituus(kunta_suomeksi) = funktio_tekstin_pituus(kunta_ruotsiksi)
ORDER BY
funktio_tekstin_pituus(kunta_suomeksi) DESC;
```
:::
<button onclick="toggleAnswer(this)" class="btn answer_btn">ratkaisu</button>
:::hidden-box
