...
seuraavilla tunnuksilla: - Sähköpostiosoite:
[info+PG\@gispo.fi](mailto:info+PG@gispo.fi){.email} - Salasana:
**pgtraining**
:::
...
\* Valitse **Servers**-osiosta oma tietokantaklusterisi \* Valitse
klusterin sisältä haluamasi tietokanta (**trainingdatabase**) \* Valitse
ylhäältä **Tools \> Query Tool**
...
Uusi taulu voidaan luoda joko kirjoittamalla seuraava SQL-komentojono
**Query Tool**:n SQL-editoriin tai ajamalla ao. solu suoraan Jupyter
Notebookista.
...
::: todo
psql:n tavoin myös createdb lukee tietokannan yhteysparametrit
