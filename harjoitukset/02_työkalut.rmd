...
* __-h db_host__ määrittää palvelimen osoitteeseen/nimen, mihin otetaan yhteyttä. (koulutusympäristössä tietokanta on db_host nimisellä palvelimella)
...
```shell
psql -h db_host -d postgres -U postgres -c "select current_database();"
``` 
